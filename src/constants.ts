...
export const CC_OBJECTS: ObjectDefinition[] = [
  { id: 'cc-1', name: '№1', category: 'Двухместный стандарт', capacity: 2, seaView: true, pricePerNight: 27000, baseType: 'chunga-changa', type: 'house' },
  ...
  { id: 'cc-11', name: '№11', category: 'Двухместный стандарт', capacity: 2, pricePerNight: 25000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-12', name: '№12', category: 'Одноместный стандарт', capacity: 1, pricePerNight: 17000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-13', name: '№13', category: 'Одноместный стандарт', capacity: 1, seaView: true, pricePerNight: 20000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-14', name: '№14', category: 'Одноместный стандарт', capacity: 1, seaView: true, pricePerNight: 20000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-15', name: '№15', category: 'Двухместный стандарт', capacity: 2, seaView: true, pricePerNight: 27000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-16', name: '№16', category: 'Двухместный стандарт', capacity: 2, seaView: true, pricePerNight: 27000, baseType: 'chunga-changa', type: 'house' },
  ...
  { id: 'cc-19', name: '№19', category: 'Двухместный стандарт', capacity: 2, pricePerNight: 25000, baseType: 'chunga-changa', type: 'house' },
  { id: 'cc-20', name: '№20', category: 'Апартаменты', capacity: 4, seaView: true, pricePerNight: 80000, baseType: 'chunga-changa', type: 'house' },
];
